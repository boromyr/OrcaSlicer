...
git merge FETCH_HEAD --no-edit
pause
@REM git fetch https://github.com/SoftFever/OrcaSlicer.git pull/11699/head
@REM git merge FETCH_HEAD --no-edit
@REM pause
git fetch https://github.com/SoftFever/OrcaSlicer.git pull/10781/head
git merge FETCH_HEAD --no-edit
pause
git fetch https://github.com/SoftFever/OrcaSlicer.git pull/11716/head
git merge FETCH_HEAD --no-edit
pause
git fetch https://github.com/SoftFever/OrcaSlicer.git pull/11681/head
git merge FETCH_HEAD --no-edit
pause
