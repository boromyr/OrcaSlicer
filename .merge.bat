...
rem ============================================================
rem  MERGE PR ORCASLICER - stato aggiornato al 2026-09-12
...
echo --- #15407 ^| OPEN ^| Feature: Add inward wipe for external perimeters ---
git fetch https://github.com/SoftFever/OrcaSlicer.git pull/15407/head
git merge FETCH_HEAD --no-edit
pause
...
echo --- #15392 ^| OPEN ^| fix: validate float-or-percent input ranges ---
git fetch https://github.com/SoftFever/OrcaSlicer.git pull/15392/head
git merge FETCH_HEAD --no-edit
pause
...
echo --- #15411 ^| OPEN ^| Print unsupported walls last ---
git fetch https://github.com/SoftFever/OrcaSlicer.git pull/15411/head
git merge FETCH_HEAD --no-edit
pause

@REM echo --- #15583 ^| MERGED ^| build: fix 9 defects found by clang-cl warnings ---
@REM git fetch https://github.com/SoftFever/OrcaSlicer.git pull/15583/head
@REM git merge FETCH_HEAD --no-edit
@REM pause

@REM echo --- #15584 ^| MERGED ^| build: clear 11 single-site clang-cl warning categories ---
@REM git fetch https://github.com/SoftFever/OrcaSlicer.git pull/15584/head
@REM git merge FETCH_HEAD --no-edit
@REM pause

echo --- #15413 ^| OPEN ^| BBS Port: Merge into Single Part ---
git fetch https://github.com/SoftFever/OrcaSlicer.git pull/15413/head
git merge FETCH_HEAD --no-edit
pause
...
echo --- #15538 ^| OPEN ^| Add numeric rotation input to Cut gizmo ---
git fetch https://github.com/SoftFever/OrcaSlicer.git pull/15538/head
git merge FETCH_HEAD --no-edit
pause
...
echo --- #15512 ^| OPEN ^| Add paint-on ironing ---
git fetch https://github.com/SoftFever/OrcaSlicer.git pull/15512/head
git merge FETCH_HEAD --no-edit
pause

echo --- #15562 ^| OPEN ^| Speed Dial Enhancements ---
git fetch https://github.com/SoftFever/OrcaSlicer.git pull/15562/head
git merge FETCH_HEAD --no-edit
pause
