...
static std::vector<std::string> s_Preset_print_options{
    ...
    "brim_width", "brim_layers", "brim_object_gap", "brim_flow_ratio", "brim_use_efc_outline", "combine_brims", "brim_type", "brim_ears_max_angle", "brim_ears_detection_length", "brim_ears_outer_only", "enable_support", "support_type", "support_threshold_angle", "support_threshold_overlap","enforce_support_layers",
...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "islands_clearance_radius", "islands_clearance_height",
    ...
    "printhost_user", "printhost_password", "printhost_ssl_ignore_revoke", "thumbnails", "thumbnails_format", "thumbnails_with_bed_gcode",
